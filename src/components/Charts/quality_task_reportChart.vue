<template>
  <div style="width: 100%;height: 90%" v-if="departPermission">
    ...
    <el-row class="table-container">
      ...
      <div v-for="(item, index) in staffOptions">
        <el-table
          class="report-table"
          :header-row-style="headerRow"
  ...
  export default {
    ...
    mounted() {
      ...
      getDepartId().then(res => {
        ...
        permsqualityreportdepart(localStorage.getItem('accountNo')).then(r => {
          ...
          if (code === 200) {
            ...
            departAgents(res.data.departId).then(response => {
              ...
              permsqualityreportstaff(localStorage.getItem('accountNo')).then(re => {
