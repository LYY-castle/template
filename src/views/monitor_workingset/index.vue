          ...
          <el-card shadow="hover" style="background-color:#339999;">
            <div slot="header" class="clearfix">
              ...
              <div style="display: inline-block;line-height: 25px;" >
                ...
                <font style="font-size:large;color:rgb(255,255,0);cursor: pointer" @click="changeToMonitorPhone()">{{ctiData.call_time_duration}}</font>
              </div>
              <div style="display: inline-block;line-height: 25px;">
                ...
                <el-col :span="8" >
                  <el-card shadow="hover" style="background-color:#f66">
                    <el-row>
                      <el-col :span="16" :offset="4">
                        <div class="circle" style="border:solid #f66 1px;background-color:#fff;">
                          <a @click="changeToMonitorPhone()"><font class="line-center" style="color:#f66;">{{ctiData.online_time_duration}}</font></a>
                        </div>
                      </el-col>
                    </el-row>
                   <div style="text-align: center">
