      ...
      <el-row>
        <el-table
          ...
          <el-table-column
            ...
            width="200">
            <template slot-scope="scope">
              <el-button @click="editVisible=true;delReq.id=scope.row.id;getWorkformRecordById(scope.row.id);" type="text" size="small">操作</el-button>
...
<script>
import { queryList, queryOne, updateWorkformRecordStatus } from '@/api/workform_record'
export default {
  name: 'workflow_todo',
  data() {
    return {
