        ...
        <el-row>
          <el-col :span="17">
            <el-form-item label="评分表描述信息">
              <el-input type="textarea" v-model='ruleForm.description' placeholder="此处填写评分表简单描述，上限100字符" maxlength="100" rows="4">{{ruleForm.description}}</el-input>
            </el-form-item>
         </el-col>
        </el-row>
    ...
    <el-dialog title="修改评分表" :visible.sync="dialogFormVisibleReverse" width="60%" @close="resetFormReverse('ruleFormReverse');dialogFormVisibleReverse=false" append-to-body>
      <el-form size="small" :model="ruleFormReverse" ref="ruleFormReverse" label-width="150px" class="demo-ruleForm">
        ...
        <el-row>
          <el-col :span="17">
            <el-form-item label="评分表描述信息">
              <el-input type="textarea" v-model='ruleFormReverse.description' placeholder="此处填写评分表简单描述，上限100字符" maxlength="100" rows="4">{{ruleFormReverse.description}}</el-input>
            </el-form-item>
          </el-col>
        </el-row>
         <el-form-item>
    ...
    <el-dialog title="查看评分表" :visible.sync="dialogFormVisibleDetail" width="60%" @close="resetFormDetail('dialogFormVisibleDetail')" append-to-body>
      <el-form size="small" :model="ruleFormDetail" ref="ruleFormDetail" label-width="150px" class="demo-ruleForm">
        ...
        <el-row>
          <el-col :span="17">
            <el-form-item label="评分表描述信息">
              <el-input type="textarea" v-model='ruleFormDetail.description' placeholder="此处填写评分表简单描述，上限100字符" readonly="readonly" maxlength="100" rows="4">{{ruleFormDetail.description}}</el-input>
            </el-form-item>
          </el-col>
        </el-row>
